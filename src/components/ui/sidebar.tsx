        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)] group-data-[state=expanded]:w-[calc(var(--sidebar-width)_+_theme(spacing.4)_+2px)]"
              : "group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r group-data-[side=right]:border-l group-data-[state=expanded]:w-[--sidebar-width]"
          )}
        >
          <div
            data-sidebar="sidebar"
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[state=expanded]:peer-data-[variant=inset]:ml-0",
        className
      )}
      {...props}
    />
